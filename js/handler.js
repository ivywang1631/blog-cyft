...
function archiveHandler(){
  ...
  api.listArchive(function(error, data){
    ...
    sortedPosts.forEach(function(post){
      $(".archive-content").append("<div class='post-preview' id='" + post.id + "'><h2 class='post-title'>" + post.title + "</h2><p class='post-meta'>" + post.text + "</div><div style='font-size: 14px; font-style: italic'>Created at: " + new Date(post.created_at) + "</div><div><a><div style='float: left;margin-right: 20px;' class='edit' id='edit-" + post.id + "'>Edit</div></a><a><div class='delete-post' id='delete-" + post.id + "'>Delete</div></a></div><hr>");
    });
    deleteHandler();
    editHandler();
  })
